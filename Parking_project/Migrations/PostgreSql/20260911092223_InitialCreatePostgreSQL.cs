    ...
    public partial class InitialCreatePostgreSQL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BiznesId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EmriBiznesit = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    NumriUnikIdentifikues = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Adresa = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    NumriBiznesit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    NumriFiskal = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    NumriPunetoreve = table.Column<int>(type: "integer", nullable: false),
                    DataRegjistrimit = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Komuna = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Telefoni = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Email = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    AllowCustomers = table.Column<bool>(type: "boolean", nullable: false),
                    QRScanner = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Emri = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Mbiemri = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Email = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    Passwordi = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NjesiteId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Emri = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    Kodi = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Adresa = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    VendeTeLira = table.Column<int>(type: "integer", nullable: false),
                    active = table.Column<bool>(type: "boolean", nullable: false),
                    BiznesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SherbimiId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Emri = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Cmimi = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    active = table.Column<bool>(type: "boolean", nullable: false),
                    BiznesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    BiznesId = table.Column<int>(type: "integer", nullable: false),
                    NjesiaId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CilsimetiId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DetajetId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FromHour = table.Column<int>(type: "integer", nullable: false),
                    ToHour = table.Column<int>(type: "integer", nullable: true),
                    Cmimi = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    active = table.Column<bool>(type: "boolean", nullable: false),
                    CilsimetiId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransaksioniId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    KohaHyrjes = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    KohaDaljes = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Statusi = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Identifikues = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    NjesiaId = table.Column<int>(type: "integer", nullable: false),
                    CilsimiId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransaksionId = table.Column<int>(type: "integer", nullable: false),
                    SherbimiId = table.Column<int>(type: "integer", nullable: false),
                    Cmimi = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
